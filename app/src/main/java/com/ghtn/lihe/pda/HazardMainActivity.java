...
public class HazardMainActivity extends Activity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentList.add(new HazardCheckFragment());
        fragmentList.add(new HazardControlFragment());
