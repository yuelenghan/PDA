...
public class QualityMainActivity extends Activity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentList.add(new QualityScoreFragment());
        fragmentList.add(new QualityCheckFragment());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.quality_main, menu);
        return true;
    }
